****************************************************
* ROLLING REGRESSION, JUN21 - JAN22
****************************************************
...
* Restrict sample
keep if inrange(date, td(01jun2021), td(01jan2022))
...
gen str20 block = "jun21-jan22"

* Optional: enforce uniqueness (should already hold)
duplicates drop

save "$data_int/term_betas_35TERMS_jun2021_jan2022.dta", replace
