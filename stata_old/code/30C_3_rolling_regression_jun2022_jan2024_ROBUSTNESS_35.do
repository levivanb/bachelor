****************************************************
* ROLLING REGRESSION, JUN22 - JAN24
****************************************************
...
* Restrict sample
keep if inrange(date, td(01jun2022), td(1jan2024))
...
gen str20 block = "jun22-jan24"

* Optional: enforce uniqueness (should already hold)
duplicates drop

save "$data_int/term_betas_35TERMS_jun2022_jan2024.dta", replace
