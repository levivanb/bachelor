****************************************************
* ROLLING REGRESSION, JUN19 - JAN21
****************************************************
...
* Restrict sample
keep if inrange(date, td(01jun2019), td(1jan2021))
...
gen str20 block = "jun19-jan21"

* Optional: enforce uniqueness (should already hold)
duplicates drop

save "$data_int/term_betas_35TERMS_jun2019_jan2021.dta", replace
