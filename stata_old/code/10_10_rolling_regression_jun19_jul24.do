****************************************************
* ROLLING REGRESSION, JUN19 - JUL24
****************************************************
...
* Restrict sample
keep if inrange(date, td(01jun2019), td(01jul2024))
...
gen str20 block = "jun19-jul24"

* Optional: enforce uniqueness (should already hold)
duplicates drop

save "$data_int/term_betas_jun2019_jul2024.dta", replace
