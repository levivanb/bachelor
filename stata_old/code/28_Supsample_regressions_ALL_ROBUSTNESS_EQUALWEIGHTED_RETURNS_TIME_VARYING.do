...
* Keep one row per trading day (ewretd etc are identical across tics anyway)
sort date tic
...
gen ret_fwd_2 = F2.ewretd
gen ret_fwd_3 = F3.ewretd
gen ret_fwd_4 = F4.ewretd
gen ret_fwd_5 = F5.ewretd
