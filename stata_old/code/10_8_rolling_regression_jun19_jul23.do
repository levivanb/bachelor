****************************************************
* ROLLING REGRESSION, JUN19 - JUL23
****************************************************
...
* Restrict sample
keep if inrange(date, td(01jun2019), td(1jul2023))
...
gen str20 block = "jun19-jul23"

* Optional: enforce uniqueness (should already hold)
duplicates drop

save "$data_int/term_betas_jun2019_jul2023.dta", replace
