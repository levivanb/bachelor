...
****************************************************
* ROLLING REGRESSION, JUN19 - JUL22
****************************************************
...
* Restrict sample
keep if inrange(date, td(01jun2019), td(1jul2022))
...
gen str20 block = "jun19-jul22"

* Optional: enforce uniqueness (should already hold)
duplicates drop

save "$data_int/term_betas_jun2019_jul2022.dta", replace
