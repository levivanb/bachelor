****************************************************
* ROLLING REGRESSION, JUN22 - JUL23
****************************************************
...
* Restrict sample
keep if inrange(date, td(01jun2022), td(1jul2023))
...
gen str20 block = "jun22-jul23"

* Optional: enforce uniqueness (should already hold)
duplicates drop

save "$data_int/term_betas_35TERMS_jun2022_jul2023.dta", replace
