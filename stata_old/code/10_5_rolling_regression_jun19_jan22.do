****************************************************
* ROLLING REGRESSION, JUN19 - JAN22
****************************************************
...
* Restrict sample
keep if inrange(date, td(01jun2019), td(1jan2022))
...
gen str20 block = "jun19-jan22"

* Optional: enforce uniqueness (should already hold)
duplicates drop

save "$data_int/term_betas_jun2019_jan2022.dta", replace
