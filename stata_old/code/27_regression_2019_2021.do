...
esttab reg1 reg2 reg3 reg4 reg5 reg6 reg7 using "$data_output/fears_predictive_regs_2019_2021.tex", ///
    replace ///
    booktabs ///
    label ///
    b(%9.4f) se(%9.4f) ///
    ...
    title("FEARS and S\&P 500 returns (2019--2021)") ///
    alignment(l*{7}{c})
