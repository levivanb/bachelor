****************************************************
* ROLLING REGRESSION, JUN19 - JUL21
****************************************************
...
* Restrict sample
keep if inrange(date, td(01jun2019), td(1jul2021))
...
gen str20 block = "jun19-jul21"

* Optional: enforce uniqueness (should already hold)
duplicates drop

save "$data_int/term_betas_35TERMS_jun2019_jul2021.dta", replace
