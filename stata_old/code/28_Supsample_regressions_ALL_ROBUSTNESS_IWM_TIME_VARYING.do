...
merge 1:1 date using "$data_int/ETF_IWM_daily.dta", keep(match master) nogen

sort date
tsset t
* Leads (next trading day)
gen ret_fwd_1 = F1.DlyRetx
gen ret_fwd_2 = F2.DlyRetx
gen ret_fwd_3 = F3.DlyRetx
gen ret_fwd_4 = F4.DlyRetx
gen ret_fwd_5 = F5.DlyRetx
