****************************************************
* ROLLING REGRESSION, JUN22 - JUL24
****************************************************
...
* Restrict sample
keep if inrange(date, td(01jun2022), td(01jul2024))
...
gen str20 block = "jun22-jul24"

* Optional: enforce uniqueness (should already hold)
duplicates drop

save "$data_int/term_betas_35TERMS_jun2022_jul2024.dta", replace
