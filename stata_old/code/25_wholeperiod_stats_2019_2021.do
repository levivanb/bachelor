****************************************************
* MOST SIGNIFICANT QUERIES BY T-STAT 2019-2021
****************************************************
...
esttab using "$data_output/top30_terms_2019_2021.tex", ///
    ...
    replace ///
    booktabs ///
    title("Top 30 Search Terms by Market Sensitivity (2019-2021)") ///
    alignment(lccc)
